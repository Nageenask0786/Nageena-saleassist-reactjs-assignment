...
const ProductCard = (props) => {
  ...
  const offerPrice = parseInt(price - discountAmount);
  return (
    <li className="product-card">
      <div className="product-image-container">
        <button type="button" className="bookmark-icon">
          <FaRegBookmark size={35} color="black" />
        </button>
        ...
        <div className="price-details">
          ...
          <div>
            <button className="bag-image">
              <img
                src="https://res.cloudinary.com/dchxbofyt/image/upload/v1708089792/Group_450_qb0vph.png"
                alt="shopping-bag"
              />
            </button>
          </div>
